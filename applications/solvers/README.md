...
- Gaussian smoothing
- Heaviside liquid fraction formulation
- Cosine kernel smoothing

These techniques improve **numerical stability during melting and solidification simulations**.

The solver framework is implemented using the **Finite Volume Method (FVM)** and is intended for:
...
While simple, this formulation may introduce **numerical oscillations near the phase interface**.
...
\gamma =
\begin{cases}
0 & T < T_m - \frac{T_{mr}}{2} \\
1 & T > T_m + \frac{T_{mr}}{2}
\end{cases}
$$
...
2. Solve pressure correction using the **PISO algorithm**  
